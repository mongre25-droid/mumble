...
def llama_cli_path():
    """Absolute path to the bundled llama.cpp CLI binary for this OS, or '' when it
    isn't present (then the local-LLM lane stays off and shaping uses the builder)."""
...
MODES_INFO = [
    ...
    ("prompt", "Prompt", "Craft an AI prompt",
     ...
     "Select Prompt in the Island or Deck, then speak your request."),
    ("email", "Email", "Draft a tidy email",
     ...
     "Select Email in the Island or Deck, then speak your message."),
]

SPOKEN_COMMANDS = [
    ("Select Prompt in the Island or Deck", "Turn your next dictation into a structured AI prompt"),
