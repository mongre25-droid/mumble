...
class Mumble:
    ...
    def _register_hotkey(self):
        spec = self._sane_press_hotkey("hotkey", "ctrl+option+d")
    ...
    def _register_quick(self):
        spec = self._sane_press_hotkey("quick_paste_hotkey", "ctrl+option+v")
        try:
    ...
    def _register_history(self):
        spec = self._sane_press_hotkey("history_hotkey", "ctrl+option+h")
        try:
