...
*correct* terms on its own (it's poor at both). Instead, when the user holds the mode
key and says "foreign", `annotate_foreign()` marks any token that phonetically
