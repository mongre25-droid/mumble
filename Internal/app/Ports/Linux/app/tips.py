...
The dictation island can surface a useful hint now and then ("Ctrl + Alt + V
...
TIPS = [
    ...
    {"id": "paste_last", "max": 3, "eligible": feature_new("quick_paste", 3),
     "text": "Ctrl + Alt + V re-pastes your last transcription"},
    ...
    {"id": "search", "max": 2, "eligible": feature_new("search", 6),
     "text": "Ctrl + Alt + S web-searches your last words"},
