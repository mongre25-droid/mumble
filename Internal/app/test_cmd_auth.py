...
import mumble  # noqa: E402  (heavy, but other tests import it too)
...
try:
    ...
    app._cmd_token = "secret-token-abc123"
    check("right token accepted",
          app._cmd_token_ok({"token": "secret-token-abc123", "cmd": "paste"}) is True)
