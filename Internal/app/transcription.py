...
API keys use the matching provider setting (groq_api_key, openai_api_key,
openrouter_api_key). A stored key is reused only when the user selects a route
for that provider; storing it does not enable cloud transcription by itself.
