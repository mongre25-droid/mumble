...
def synthesize_with_fallback(text, voice_id=None, model=None,
    ...
    # One invocation authorizes one provider.  Model fallback remains available
    # inside that provider, but a different service requires a new explicit
    # decision rather than silently using another saved credential.
