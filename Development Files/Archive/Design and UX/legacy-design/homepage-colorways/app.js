...
(function () {
  ...
  (function () {
    var themes = [
      ...
      { id: 'cyber-lime', name: 'Cyber Lime', class: 'theme-cyber-lime', color: '#00FF66' },
      { id: 'magma-copper', name: 'Magma Copper', class: 'theme-magma-copper', color: '#B87333' },
      { id: 'glacier-steel', name: 'Glacier Steel', class: 'theme-glacier-steel', color: '#7B8FA1' },
      { id: 'orchid-bloom', name: 'Orchid Bloom', class: 'theme-orchid-bloom', color: '#E84393' },
      { id: 'volt-electric', name: 'Volt Electric', class: 'theme-volt-electric', color: '#FFE600' }
    ];
