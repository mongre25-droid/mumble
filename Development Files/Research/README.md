...
Research files are evidence and working analysis. They can inform a decision, but they do not define current product behaviour. Verify any proposed change against `Internal/app/` and record the final decision in the relevant Core document.

The active research kept here covers:

- dictation duration, segmentation, recovery, latency, streaming, warm-state evidence, and the ranked open-source adoption register in `mumble-dictation-latency-research.md`;
